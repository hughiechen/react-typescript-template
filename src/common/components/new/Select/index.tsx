...
import { autoOpenDropdown, AutoOpenDropdownProps } from '../../higherOrder/autoOpenDropdown'
...
export interface SelectProps<T = any, S extends boolean = false> extends Omit2<AntdSelectProps<T>, 'onChange' | 'allowClear' | 'options'>, AutoOpenDropdownProps {
...
export class Select<T, S extends boolean = false> extends PureComponent<SelectProps<T, S>> {
  static defaultProps: PickOptional<SelectProps<any>> = {
    undefinedAsAllLabel: intl.get('report_all').d('全部'),
